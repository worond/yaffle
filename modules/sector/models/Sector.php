 ...
 *
 * @property SectorCategory $category
 * @property File $icon
 * @property File $image
 * @property Seo $seo
 * @property File $thumbnail
 * @property SectorImage[] $sectorImages
 * @property File[] $files
 */
class Sector extends ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['category_id'], 'exist', 'skipOnError' => true, 'targetClass' => SectorCategory::className(), 'targetAttribute' => ['category_id' => 'id']],
    ...
    {
        return $this->hasOne(SectorCategory::className(), ['id' => 'category_id']);
    }
     ...
     * @return \yii\db\ActiveQuery
     */
    public function getSectorImages()
    {
        return $this->hasMany(SectorImage::className(), ['sector_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(File::className(), ['id' => 'file_id'])->viaTable('{{%sector_image}}', ['sector_id' => 'id']);
    }
